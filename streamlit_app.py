...
with col2:
        ...
        st.write("In order to understand what direction your inputs affect your risk estimate we need an effect plot. An effect plot shows how much, and in which direction, the different values of each input on average affects the risk assessment.")
